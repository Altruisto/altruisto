  ...
  <>
    ...
    <div className="container pt-4">
      <div className="row">
        ...
        >
          <h1 style={{ marginBottom: "30px" }}>Subscribe to Altruisto Newsletter</h1>
          ...
          <h3 style={{ marginBottom: "10px", textAlign: "left", width: "100%;" }}>
            Sign up here for updates on our progress, ways for doing the most good and content we
            consider valuable, whether it be informative, inspiring or simply amusing! We promise to
