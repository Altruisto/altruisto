  ...
  return (
    <>
      <div className="menu__top">
        ...
        <button
          className={`menu__toggler navbar-toggler navbar-toggler-right${(collapsed ? " collapsed" : "")}`}
          type="button"
      ...
      <div
        className={`menu__collapse navbar-collapse${(inTransition ? " collapsing" : (collapsed ? " collapse" : " collapse show"))}`}
